...
def main() -> None:
    ...
    parser.add_argument("--answer-video-root", default="../private_data/answers/videos")
    parser.add_argument("--challenge-root", default="../private_data/challenge")
    parser.add_argument("--output-csv", default="../private_csv/answer_features.csv")
    parser.add_argument("--action-stats-path", default="../private_data/so100_action_statistics.json")
    parser.add_argument("--action-extractor-ckpt", default="../private_checkpoints/action_extractor.ckpt")

...
def main() -> None:
    ...
    parser.add_argument("--answer-csv", default="../csv/answer_features.csv")
    ...
    parser.add_argument("--public-sample-id-file", default="../csv/public_ids.txt", help="Text file containing public sample ids.")
